					...
					<div class="modal-body">
						<div class="form-group">
							<select name="setting" class="we7-select">
								<option value="displayorder" <?php  if('displayorder' == $notice_display) { ?>selected<?php  } ?>>按排序数字大小倒序</option>
								<option value="createtime" <?php  if('createtime' == $notice_display) { ?>selected<?php  } ?>>按添加时间倒序</option>
							</select>

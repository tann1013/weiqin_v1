...
<form action="" method="post" class="we7-form form" id="form">
	...
	<div class="remote-ftp" <?php  if(empty($remote['type']) || $remote['type'] != '1') { ?> style="display:none;" <?php  } ?>>
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				<input type="password" name="ftp[password]" class="form-control encrypt" value="<?php  echo $remote['ftp']['password'];?>" />
			</div>
		</div>
		<div class="form-group">
	...
	<label class="col-xs-12 col-sm-3 col-md-2 control-label">bucket所在区域</label>
		<div class="col-sm-9 col-xs-12">
			<select class="form-control" name="cos[local]">
				<option value="ap-beijing-1" <?php  if($remote['cos']['local'] == 'ap-beijing-1') { ?>selected<?php  } ?>>北京一区（已售罄）</option>
				<option value="ap-beijing" <?php  if($remote['cos']['local'] == 'ap-beijing') { ?>selected<?php  } ?>>北京</option>
				<option value="ap-nanjing" <?php  if($remote['cos']['local'] == 'ap-nanjing') { ?>selected<?php  } ?>>南京</option>
				<option value="ap-shanghai" <?php  if($remote['cos']['local'] == 'ap-shanghai') { ?>selected<?php  } ?>>上海</option>
				<option value="ap-guangzhou" <?php  if($remote['cos']['local'] == 'ap-guangzhou') { ?>selected<?php  } ?>>广州</option>
				<option value="ap-chengdu" <?php  if($remote['cos']['local'] == 'ap-chengdu') { ?>selected<?php  } ?>>成都</option>
				<option value="ap-chongqing" <?php  if($remote['cos']['local'] == 'ap-chongqing') { ?>selected<?php  } ?>>重庆</option>
				<option value="ap-shenzhen-fsi" <?php  if($remote['cos']['local'] == 'ap-shenzhen-fsi') { ?>selected<?php  } ?>>深圳金融</option>
				<option value="ap-shanghai-fsi" <?php  if($remote['cos']['local'] == 'ap-shanghai-fsi') { ?>selected<?php  } ?>>上海金融</option>
				<option value="ap-beijing-fsi" <?php  if($remote['cos']['local'] == 'ap-beijing-fsi') { ?>selected<?php  } ?>>北京金融</option>
				<option value="ap-hongkong" <?php  if($remote['cos']['local'] == 'ap-hongkong') { ?>selected<?php  } ?>>中国香港</option>
				<option value="ap-singapore" <?php  if($remote['cos']['local'] == 'ap-singapore') { ?>selected<?php  } ?>>新加坡</option>
				<option value="ap-mumbai" <?php  if($remote['cos']['local'] == 'ap-mumbai') { ?>selected<?php  } ?>>孟买</option>
				<option value="ap-seoul" <?php  if($remote['cos']['local'] == 'ap-seoul') { ?>selected<?php  } ?>>首尔</option>
				<option value="ap-bangkok" <?php  if($remote['cos']['local'] == 'ap-bangkok') { ?>selected<?php  } ?>>曼谷</option>
				<option value="ap-tokyo" <?php  if($remote['cos']['local'] == 'ap-tokyo') { ?>selected<?php  } ?>>东京</option>
				<option value="na-siliconvalley" <?php  if($remote['cos']['local'] == 'na-siliconvalley') { ?>selected<?php  } ?>>硅谷</option>
				<option value="na-ashburn" <?php  if($remote['cos']['local'] == 'na-ashburn') { ?>selected<?php  } ?>>弗吉尼亚</option>
				<option value="na-toronto" <?php  if($remote['cos']['local'] == 'na-toronto') { ?>selected<?php  } ?>>多伦多</option>
				<option value="eu-frankfurt" <?php  if($remote['cos']['local'] == 'eu-frankfurt') { ?>selected<?php  } ?>>法兰克福</option>
				<option value="eu-moscow" <?php  if($remote['cos']['local'] == 'eu-moscow') { ?>selected<?php  } ?>>莫斯科</option>
			</select>
...
<script type="text/javascript">
	...
	var alibucket = '<?php  echo $_W['setting']['remote_complete_info']['alioss']['bucket'];?>';
